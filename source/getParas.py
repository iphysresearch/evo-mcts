...
class Paras():
    def __init__(self):
        ...
        ### General settings  ###
        #####################
        self.method = 'evo_mcts'
        self.problem = 'gw_mlgwsc1'
        ...
        ###  EC settings  ###
        #####################
        self.pop_size = 4  # Size of Elite set E, default = 10
        self.init_size = 1  # Number of initial nodes N_I, default = 4
        self.ec_fe_max = 10000  # Number of evaluations, default = 1000
        # self.ec_operators = ['s2','s3','e3', 'e3', 'm3'] # ['e1', 'e2', 'm1', 'm2', 's1']
        self.ec_operators = ['e3']*3 + ['s2','s3','m3','m6','m7'] # ['e1', 'e2', 'm1', 'm2', 's1']
        self.ec_m = 5
        # self.ec_operator_weights = [0, 1, 2, 2, 1]  # weights for operators default = [0,1,k,k,1], default = [0,1,2,2,1]
        self.ec_operator_weights = [1,]*len(self.ec_operators)  # weights for operators default = [0,1,k,k,1], default = [0,1,2,2,1]
